...
BOOL CCommThread::OpenPort(WORD wPortID, DWORD dwBaud)
{
	// Local 변수.
	...
	m_sPortName = "\\\\.\\" + m_sPortName;		//by kwonhk 20120126


	m_hComm = CreateFile((LPCTSTR)m_sPortName, 
